...
void hexStringToUInt32Array(char *hexString, uint32_t *outputArray) {
...
int main(int argc, char** argv) {
    ...
    printf("H(K) : ");
    char *chaine1 = "41414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141414141";
    char chaine_bytes1[65];
    hexStringToBytesArray(chaine1, 64, chaine_bytes1);
    chaine_bytes1[64] = 0;

    struct md5_digest digest1;
    md5(chaine_bytes1, &digest1, NULL);
    print_hash(digest1.bytes);



    printf("H(K||name||expiry) : ");
    char *chaine = "";
    char chaine_bytes[129];
    hexStringToBytesArray(chaine, 128, chaine_bytes);
    chaine_bytes[128] = 0;

    struct md5_digest digest;
    md5(chaine_bytes, &digest, NULL);
    print_hash(digest.bytes);


    printf("iv = H(K)\n");
    // hash avec, pour iv le hash précédent
    chaine = "6e616d656e616d656e616d656e616d656e616d656e616d656e616d656e616d656e616d656e616d656e616d656e616d656e616d656e23323032342d31302d3237";
    char chaine_bytes2[65];
    hexStringToBytesArray(chaine, 64, chaine_bytes2);
    chaine_bytes2[64] = 0;
    int32_t iv[4];
    digestToBytes(&digest1, iv);
    md5(chaine_bytes2, &digest, iv);
    printf("iv      : %08x-%08x-%08x-%08x\n", iv[0], iv[1], iv[2], iv[3]);
    printf("H(name||expiry)  : ");
    print_hash(digest.bytes);
